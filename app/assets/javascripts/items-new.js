$(function(){
  ...
  // }
  var buildImg = (index, url)=> {
    const html = `<div class="contents__image__main__left__box" data-index="${index}"><div class="contents__image__main__left__box__image" data-index="${index}">
    <img data-index="${index}" src="${url}" width="100px" height="100px"></div>
      <div class="contents__image__main__left__box__btns">
        <div class="contents__image__main__left__box__btns__remove" data-index="${index}">削除</div>
      </div>
      </div>`;
    return html;
  }
  ...
  // $('#image-box').on('change', '.contents__image__form__text__js-file_group__file', function(e) {
    ...
    if (img = $(`img[data-index="${targetIndex}"]`)[0]) {
      ...
      $('.contents__image__main__left').append(buildImg(targetIndex, blobUrl));
  ...
  $(".contents__image__main__left").on("click", ".contents__image__main__left__box__btns__remove",function(){
